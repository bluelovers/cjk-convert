 ...
 * @type {IFrom2To}
 */
export declare const jp2zht: jpConvert.IFrom2To;
/**
 * only 只將 日文漢字 => 轉為簡漢字
 * @type {IFrom2To}
 */
export declare const jp2zhs: jpConvert.IFrom2To;
/**
 * only 簡漢字 => 轉為日漢字
 * @type {IFrom2To}
 */
export declare const zhs2jp: jpConvert.IFrom2To;
/**
 * only 只將 繁漢字 => 轉為日文漢字
 * @type {IFrom2To}
 */
export declare const zht2jp: jpConvert.IFrom2To;
/**
 * only 只將簡繁日 當中共通的 繁漢字 => 轉為簡漢字
 * 請勿作為簡繁轉換用
 * @type {IFrom2To}
 */
export declare const zht2zhs: jpConvert.IFrom2To;
/**
 * only 只將簡繁日 當中共通的 簡漢字 => 轉為繁漢字
 * 請勿作為簡繁轉換用
 * @type {IFrom2To}
 */
export declare const zhs2zht: jpConvert.IFrom2To;
/**
 ...
 * @returns {string}
 */
export declare const cjk2jp: typeof jpConvert.zh2jp;
/**
