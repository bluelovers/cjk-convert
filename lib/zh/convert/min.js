...
const table_tw2cn_debug_json_1 = __importDefault(require("@lazy-cjk/static-build-zh-convert/data/table_tw2cn.debug.json"));
exports.tableTw2CnDebug = table_tw2cn_debug_json_1.default;
const table_cn2tw_debug_json_1 = __importDefault(require("@lazy-cjk/static-build-zh-convert/data/table_cn2tw.debug.json"));
